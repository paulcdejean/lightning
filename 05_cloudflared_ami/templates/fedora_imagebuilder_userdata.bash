...
curl --retry 5 --retry-all-errors --no-progress-meter -L https://s3.dualstack.${region}.amazonaws.com/amazon-ssm-${region}/latest/linux_arm64/amazon-ssm-agent.rpm -o /tmp/amazon-ssm-agent.rpm
